                    ...
                    for next_piece_rotations in range(len(next_piece._rotations)):
                        ...
                        for next_piece_positions in range(-2,cur_field.width):
                            ...
                            if test_field:
                                ...
                                #    #best_next_piece_position = next_piece_position

                                #log.write(str(best_piece_position)+" "+str(best_piece_rotation)+"\n\n")

                                #log.write(holes + ", " + complete_lines + ", " + total_height + ", " + bumpiness+"\n\n")
